      ...
      reviews: [
        {
          ...
          score: 4.5,
          comment:
            "A mind-bending experience with a gripping storyline and stunning visuals.",
        },
        {
          ...
          score: 4.0,
          comment:
            "Inception is a rare Hollywood blockbuster that gets everything right.",
        },
      ],
    },
    {
      ...
      reviews: [
        {
          ...
          score: 5.0,
          comment:
            "The Dark Knight is a film that redefines the possibilities of superhero cinema.",
        },
        {
          critic: "Peter Travers",
          publication: "Rolling Stone",
          score: 4.5,
          comment:
            "A towering achievement that soars on the strengths of its cast and director.",
        },
      ],
    },
    {
...
/*
    data.movies.forEach((x)=>{
        ...
        x.cast.forEach((y)=>{
            console.log(y.name + " - " + y.role)
        })
        x.reviews.forEach((y)=>{
            console.log(y.critic + " - " + y.publication + " - " + y.score + " - " + y.comment)
        })
    })
    */

const newData = data.movies.map((movies) => {
  return movies;
});
